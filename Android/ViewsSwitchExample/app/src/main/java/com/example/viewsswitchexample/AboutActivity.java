...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (arguments != null) {
            KeyItem keyItem = (KeyItem) arguments.getSerializable("user_input_key_item");

            TextView textView = findViewById(R.id.dataTextView);
            textView.setText(String.format("Key: %s\nDescription: %s", keyItem.getKey(), keyItem.getDescription()));
        }
