...
public:
	int** data;
	Dyn2DArr(int sizeXP, int sizeYP) : sizeY{ sizeYP }, 
	...
	friend ostream& operator<<(ostream& out, const Dyn2DArr d)
	{
...
//{
//    int size;
//    MedalRow* medalRows = new MedalRow[size];
//};
//
//void printRows(MedalRow* medalRows, int size)
//{
//    for (int i = 0; i < size; i++)
//    {
//        cout << medalRows[i].country << "\t"
//            << medalRows[i].medals[GOLD] << "\t"
//            << medalRows[i].medals[SILVER] << "\t"
//            << medalRows[i].medals[BRONZE] << endl;
//    }
//    cout << endl;
//}
//
//void printTable(MedalTable mt)
//{
//    cout << "Страна\tЗолото\tСеребро\tБронза" << endl;
//    printRows(mt.medalRows, mt.size);
//}
//int main()
//{
//    SetConsoleCP(1251);
//    SetConsoleOutputCP(1251);
//
//    MedalRow russia{ "RUS",new int[3] {4,5,3} };
//    MedalRow usa{ "USA",new int[3] {4,5,3} };
//    MedalTable table{ 2,new MedalRow[2] {russia,usa} };
//
//    printTable(table);
//
//    /*map<string, int*> medalsTable;
//    medalsTable.insert(make_pair("RUS", new int[3] {2,3,4}));*/
//    //cout << medalsTable["RUS"][GOLD];
//
